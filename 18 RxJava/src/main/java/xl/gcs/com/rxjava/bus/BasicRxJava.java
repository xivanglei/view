...
public class BasicRxJava {
    ...
    public static void basicComeTrue() {
        ...
        //创建被观察者 call方法里选择哪个观察者添加观察数据，onNext添加完数据后，需要onCompleted(),通过这种方式添加的数据，下面只需要执行订阅，括号里不用传参数，传了也没用，那个观察者添加了数据，都会运行
//        Observable mObservable = Observable.create(new Observable.OnSubscribe() {
//            @Override
//            public void call(Object o) {
//                mSubscriber.onNext("杨影枫");
//                mSubscriber.onNext("月眉儿");
//                mSubscriber.onCompleted();
//                mObserver.onNext("123");
//                mObserver.onNext("321");
